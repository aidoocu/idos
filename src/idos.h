...
#include "os/arch/arch.h"

/** Definiciones del kernel  */
#include "os/kernel/task.h"
#include "os/kernel/ipc.h"
#include "os/kernel/sch.h"


/** Definiciones del sistema */
#include "os/sys/timer.h"
#include "os/sys/autostr.h"
#include "os/sys/uart.h"
#include "os/sys/sleep.h"


#ifdef NET_STACK
#include "os/sys/net/netstack.h"
#endif
